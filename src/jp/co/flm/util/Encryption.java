...
public class Encryption {
	 ...
	 * keyとAPPENDSTRにより作成されたソルト値を利用しているため、
	 * keyには重複しない値を指定すること
	 * 戻り値であるハッシュ値はSTRETCHCOUNTで指定された回数ストレッチされている。
	 *
	 * @param key ソルト値生成のための固有の値
	 * @param target ハッシュ化前の文字列
	 * @return ハッシュ化後の文字列
	 * @throws NoSuchAlgorithmException SHA256が利用できない場合
	 */
